/*
 * Contains wrappers for different CPU functions, as well as the `IoPort` struct
 * for reading and writing to I/O-ports.
 *
 * Author: Michael Schoetter, Heinrich Heine University Duesseldorf, 2024-06-09
